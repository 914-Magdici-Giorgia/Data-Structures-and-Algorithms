...
void testAll() { 
	...
	SortedSet set1(r2);
	assert(set1.add(1) == true);
	assert(set1.add(2) == true);
	assert(set1.add(3) == true);
	assert(set1.add(4) == true);
	assert(set1.add(5) == true);
	assert(set1.add(6) == true);

	SortedSet set2(r2);
	assert(set2.add(1) == true);
	assert(set2.add(2) == true);
	assert(set2.add(3) == true);
	...
	assert(set1.add(2) == true);
	assert(set1.add(3) == true);
	assert(set1.add(4) == false);
	assert(set1.add(5) == false);
	assert(set1.add(6) == false);
